...
import { codingLanguages, frontendDevelopment, backendDevelopment, developmentTools } from '@/config/SkillsConfig';

// Import Swiper styles
import 'swiper/swiper-bundle.css';
import ScrollSlideAnimation from '@/components/Common/animations/ScrollSlideAnimation';
